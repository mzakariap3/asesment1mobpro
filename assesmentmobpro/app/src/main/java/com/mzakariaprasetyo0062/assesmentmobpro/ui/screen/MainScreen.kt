package com.mzakariaprasetyo0062.assesmentmobpro.ui.screen
...
import com.mzakariaprasetyo0062.assesmentmobpro.R
...
fun MainScreen(onNavigateToAbout: () -> Unit) {
    ...
    Scaffold(
            ...
            TopAppBar(
                ...
                actions = {
                    IconButton(onClick = onNavigateToAbout) {
                        Icon(Icons.Default.Info, contentDescription = stringResource(R.string.about_menu))
                    }
                }
            )
        }
        ...
        Column(
            ...
            Text(stringResource(R.string.difficulty_label), modifier = Modifier.align(Alignment.Start))
            ...
            Button(
                onClick = {
                    if (weight.isEmpty()) {
                        ...
                        // MENGGUNAKAN STRING FORMAT UNTUK RESULT_MSG
                        resultText = context.getString(R.string.result_msg, weight, calories.toInt().toString())
                    }
                },
                modifier = Modifier.fillMaxWidth()
            ) {
